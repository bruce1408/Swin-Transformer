...
# Licensed under The MIT License [see LICENSE for details]1111
# Written by Ze Liu
# --------------------------------------------------------
...
from utils import load_checkpoint, load_pretrained, save_checkpoint, NativeScalerWithGradNormCount, auto_resume_helper, \
    reduce_tensor, reduce_tensor_single_gpu
...
def validate(config, data_loader, model):
    ...
    for idx, (images, target) in enumerate(data_loader):
        ...
        # single gpu device
        acc1 = reduce_tensor_single_gpu(acc1)
        acc5 = reduce_tensor_single_gpu(acc5)
        loss = reduce_tensor_single_gpu(loss)
